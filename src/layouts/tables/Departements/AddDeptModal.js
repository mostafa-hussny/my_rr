...
const AddDeptModal = ({ handleClose, handleOpen, open, setrefetch, refetch }) => {
  ...
  const addData = (e) => {
    ...
    formDataObject.append("enName", formData.enName);
    formDataObject.append("enDescription:", formData.enDescription);
    formDataObject.append("description", formData.description);
    formDataObject.append("image", selectedImage);
    // Send a POST request using Axios

    axios
      .post(baseurl + "Category", formDataObject)
      .then((response) => {
